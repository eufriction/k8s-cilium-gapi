# https-ns-restricted-same-hostname — per-listener namespace restriction on same hostname
...
| ------------------------------------------------------------------------------------ | --------------------------------------------------------------- |
| [http-ns-restricted-split-port](../http-ns-restricted-split-port/README.md)          | Namespace restriction on split HTTP ports (different hostnames) |
| [https-ns-restricted-shared-port](../https-ns-restricted-shared-port/README.md)      | Namespace restriction on shared HTTPS port                      |
| [http-grpc-same-hostname](../../03-multi-listener/http-grpc-same-hostname/README.md) | Split ports, same hostname (no namespace restriction)           |

## Run

```sh
mise run //scenarios/04-route-admission/https-ns-restricted-same-hostname:start
```
