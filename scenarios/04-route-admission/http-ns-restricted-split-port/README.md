# http-ns-restricted-split-port — Namespace restriction on split HTTP ports
...
- [`http-ns-allowed`](../http-ns-allowed/README.md) — same concept on split ports without explicit hostnames
- [`https-ns-restricted-shared-port`](../https-ns-restricted-shared-port/README.md) — same concept on shared HTTPS port 443

## Run

```sh
mise run //scenarios/04-route-admission/http-ns-restricted-split-port:start
```
