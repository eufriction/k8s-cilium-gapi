...
retry_until 10 assert_listener_status ns-split-port-gateway gateway-system http-restricted 0 HTTPRoute GRPCRoute
retry_until 10 assert_listener_status ns-split-port-gateway gateway-system http-open 1 HTTPRoute GRPCRoute
