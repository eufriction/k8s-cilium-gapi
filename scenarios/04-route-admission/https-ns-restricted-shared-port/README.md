# https-ns-restricted-shared-port — Namespace restriction on shared HTTPS port
...
- [`http-ns-allowed`](../http-ns-allowed/README.md) — same concept with HTTP on split ports (80/8080), no hostnames
- [`http-ns-restricted-split-port`](../http-ns-restricted-split-port/README.md) — split ports with explicit hostnames

## Run

```sh
mise run //scenarios/04-route-admission/https-ns-restricted-shared-port:start
```
