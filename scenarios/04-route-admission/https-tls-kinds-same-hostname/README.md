# https-tls-kinds-same-hostname — HTTPS + TLS passthrough with `allowedRoutes.kinds` on split ports
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------- |
| [https-tls-same-hostname](../../03-multi-listener/https-tls-same-hostname/README.md) | Same topology without kind restriction            |
| [https-tls-kinds-shared-port](../https-tls-kinds-shared-port/README.md)              | HTTPS + TLS with kind restriction on shared port  |
| [https-grpc-kinds-split-port](../https-grpc-kinds-split-port/README.md)              | HTTPS + gRPC with kind restriction on split ports |

## Run

```sh
mise run //scenarios/04-route-admission/https-tls-kinds-same-hostname:start
```
