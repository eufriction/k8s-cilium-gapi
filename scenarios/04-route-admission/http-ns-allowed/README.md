# http-ns-allowed — allowedRoutes.namespaces per-listener enforcement
...
- [http-ns-restricted-split-port](../http-ns-restricted-split-port/README.md) — split ports with explicit hostnames on each listener
- [https-ns-restricted-shared-port](../https-ns-restricted-shared-port/README.md) — shared HTTPS port with different hostnames

## Run

```sh
mise run //scenarios/04-route-admission/http-ns-allowed:start
```
