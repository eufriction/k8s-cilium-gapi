# http-https-tls-implicit-kinds — HTTP + HTTPS + TLS Passthrough on shared port (no explicit kinds)
...
```sh
mise run //scenarios/04-route-admission/http-https-tls-implicit-kinds:start
```
