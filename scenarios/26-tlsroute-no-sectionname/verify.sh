...
kubectl wait certificate/scenario-26-gateway-certificate -n gateway-system --for=condition=Ready --timeout=180s
...
curl -kfsS --resolve "web.example.test:443:127.0.0.1" https://web.example.test/headers >/dev/null
