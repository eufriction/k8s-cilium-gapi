...
This scenario combines the **single shared-port** layout of [`21-http-grpc-shared-port`](../../01-simple/http-grpc-shared-port/README.md) with **explicit `allowedRoutes.kinds`** restrictions on the Gateway listener.
...
| ----------------------------------------------------- | ------------------------------------------ | ---------------- |
| [21](../../01-simple/http-grpc-shared-port/README.md) | None (implicit — accepts all kinds)        | ✅ Works         |
| [22](../kinds-split-port/README.md)                   | One kind per listener, separate ports      | ✅ Works         |
...
| ------------------------------------------------------------------------ | ----------- | -------------------- | ------------------------------ |
| [http-grpc-split-port](../../01-simple/http-grpc-split-port/README.md)   | 443 + 50051 | 2 (one per protocol) | None (implicit)                |
| [http-grpc-shared-port](../../01-simple/http-grpc-shared-port/README.md) | 443         | 1 (shared)           | None (implicit)                |
| [kinds-split-port](../kinds-split-port/README.md)                        | 443 + 50051 | 2 (one per protocol) | One kind per listener          |
...
For the split-port variant with per-listener kind restrictions (works), see [`scenarios/02-listener-policy/kinds-split-port`](../kinds-split-port/README.md).
