...
| `02-listener-policy` | namespace-restricted-shared-port              |   ✅   |   ✅   |      —       |       —       |           —            |      ⏭️      |
...
| `03-multi-port`      | https-tls-same-hostname-split-port            |   —    |   —    |      —       |       —       |           —            |      ⏭️      |
| `03-multi-port`      | kind-restricted-https-tls-split-port          |   —    |   —    |      —       |       —       |           —            |      ⏭️      |
| `03-multi-port`      | namespace-restricted-same-hostname-split-port |   —    |   —    |      —       |       —       |           ⏭️           |      ⏭️      |
