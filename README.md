...
| `06-extensions`      | [`http-ext-proc-waf`](scenarios/06-extensions/http-ext-proc-waf/README.md)                                          | All traffic through Coraza WAF ext_proc via cross-namespace `CiliumEnvoyExtProcFilter` backend allowed by `ReferenceGrant` | Branch only                |
